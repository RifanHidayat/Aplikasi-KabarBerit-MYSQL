...
import 'package:kabarnagari/ui/DetailScreen.dart';


class   PoliticsSection extends StatefulWidget {
  @override
  _PoliticsSectionState createState() => _PoliticsSectionState();
}

class _PoliticsSectionState extends State<PoliticsSection> {
  Map data;
  List dataNews = [];
  var loading = false;
  Map datadetail;
